...
🛰️ RUTA CORPORATIVA – PRIORIDAD UNO  

📦 CARGAMENTO: B90  
📅 ENTREGA: HOY  
🔒 AUTORIZACIÓN: CONSEJO CORPORATIVO  

🗺️ ITINERARIO DESIGNADO:  
➡️ SECTOR 39 – San Diego, California  
➡️ SECTOR A7 – Tokio, Japón [+1]  
➡️ Estambul [+2 / –1]  
➡️ B90 – Berlín, Alemania [–2 / ++1]  
➡️ SECTOR 38 – Tijuana, Baja California [––1]  

⚠️ Prioridad escalada // Clasificación Seis → Uno  
{{< /glitch-box >}}
...
{{< serial-header
entry="REGISTRO-ALANA-002"
title="Preconfiguración del arma y vestimenta táctica"
subject="Alana Hicks"
location="Armería Interna // Walk-in Corporativo"
timestamp="2123.08.04-T09:03"
access="OMEGA"
threat="Media (Armamento activado / estado reflexivo)"
>}}
...
{{< glitch-box >}}
MEMORIA EVOCADA — TEXTIL / OLOR  
Olor activador: cuero real / chamarra  
Asociaciones: Nueve Días / Apoptosis / hogar abandonado  
Estado: náusea emocional / rechazo de excesos corporativos  
Reflexión: desconexión voluntaria / renuncia al regreso  
{{< /glitch-box >}}
...
WAR: MODELO TENEBRIS 15b ESTÁ LLEGANDO A FINAL DE SOPORTE  
CONSULTE AL MANUFACTURADOR PARA REEMPLAZO  
{{< /glitch-box >}}
...
{{< serial-header
entry="REGISTRO-ALANA-003"
title="Identificación tripartita y descenso al subsuelo"
subject="Alana Hicks"
location="Torre Corporativa S-T12 // Estacionamiento Nivel –50"
timestamp="2123.08.04-T10:22"
access="OMEGA"
threat="Latente (Análisis de seguridad / tránsito restringido)"
>}}
...
{{< glitch-box >}}
🔒 SEGURIDAD CORPORATIVA — IDENTIFICACIÓN MULTINIVEL  
Nivel 1: Visual básico (fácilmente evadible)  
Nivel 2: Red de transmisores personales / RFID ambiental  
Nivel 3: Cadena única de encriptación generada por datos vitales  
Vulnerabilidad: alta en generaciones anteriores a 2083  
Estado: aceptable con refuerzo de red pasiva  
{{< /glitch-box >}}

El último método se hacía por medio de una enorme cadena de encriptacion, cada persona tenia un codigo unico que, teóricamente, no podría repetirse...
...
-Flecha Rota, ¿cuánto tiempo?  
-Mi triciclo dice que faltan diez minutos.  
-No puedo ir más rápido en esta basura.  
-Voy a remover el seguro, toma el control.  
-Ya marqué la ruta más rápida, estoy desviando tráfico.  
-No es necesario, aún tengo suficiente tiempo.  
-Aparte no puedo ir más rápido que lo que ya iba.  
-Estoy cambiando eso también.  
🔓 Candado abierto — velocidad liberada a 160km/h  
-Vamos a cambiar tu vehículo de salida, vas a tomar un Martillo.  
-¿Un Martillo, por qué?  
-No es una pregunta. Ruta: Castigo de Adán.  
-La situación me pide no llamar la atención.  
-Vas a pasar a la armería. Tiro HALO. Destino: Sendai A12 para tu +1.  
-¿Por qué Sendai? ¿Qué es mi +1?  
-No puedo indicarlo en el canal.  
-Sabes que es mi +1 y me lo vas a decir.  
-Tu +1 es un +++1. Señuelo en Estambul desde San Diego.  
-Apreciaría un aviso más temprano.  
-Todavía estamos a tiempo.  
-¿Qué más tengo que saber?  
-El material lo dejas en Berlín. Contacto local te dará detalles.  
-¿Qué interés tiene la Corporación en Berlín?  
-No se discute en este canal.  
-Gracias por el adelanto.  
-¿Por qué no puedo vivir en una cápsula cerca del punto de salida?  
-Porque te queremos demasiado.  
-Quiero discutirlo con alguien más arriba.  
-Eso no va a pasar.  
-Me gusta pensar que alguien aparte de ti escucha esto.  
-No agregaré nada a eso.  
{{< /glitch-box >}}

Alana había llegado a otro estacionamiento, el lugar parecía abandonado pero esto era una apariencia que se había quedado después de los eventos de los últimos cuarenta años, estacionó el vehículo al fondo, en una sección oscura del enorme estacionamiento y procedió a un cuadro de elevadores oculto detrás de columnas de concreto. Una de las puertas abrió lentamente, una vez adentro Alana esperó otra eternidad para que el elevador la llevará hasta una serie de pasillos de concreto sin marcas ni indicaciones.
